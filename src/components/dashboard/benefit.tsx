        ...
        <div className="w-full h-screen flex items-center justify-center bg-charcoal">
            <MaxWidthWrapper classNames="flex flex-col gap-4 items-center">
                <div className="grid grid-cols-[2fr_1.5fr]  gap-10 w-full">
                    ...
                    {/* Right - Spans 2 Rows */}
                    <div className="row-span-2 bg-white/10 p-6 shadow rounded-xl flex flex-col items-center justify-between">
                    ...
                    <div className="grid grid-cols-2 gap-5">
                            <div className="w-full bg-white/10 rounded-lg p-4 flex flex-col gap-2">
                                <div className="flex items-center gap-2">
                                    <div className="w-10 h-10 rounded-full bg-white/50 overflow-hidden shrink-0 grow flex items-center justify-center">
                                ...
                                <div className="relative mt-2">
                                    <QuoteIcon className="text-white absolute -left-3 -top-1 size-3 rotate-[200deg]"/>
                                    <QuoteIcon className="text-white absolute right-0 -bottom-1 size-3 rotate-[20deg]"/>
                            ...
                            <div className="w-full bg-white/10 rounded-lg p-4 flex flex-col gap-2">
                                <div className="flex items-center gap-2">
                                    <div className="w-10 h-10 rounded-full bg-white/10 overflow-hidden shrink-0 grow flex items-center justify-center">
                                ...
                                <div className="relative mt-2">
                                    <QuoteIcon className="text-white absolute -left-3 -top-1 size-3 rotate-[200deg]"/>
                                    <QuoteIcon className="text-white absolute left-16 -bottom-1 size-3 rotate-[20deg]"/>
                                    <p className="text-white text-sm">
